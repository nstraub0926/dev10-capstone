...
import learn.club.data.AppUserRepository;
import learn.club.domain.ActionStatus;
import learn.club.domain.Result;
import learn.club.models.AppUser;
...
public class AppUserService implements UserDetailsService {
    ...
    public Result<AppUser> create(String username, String password, String role) {
        ...
        AppUser appUser = new AppUser(0, username, password, true, List.of(role));
